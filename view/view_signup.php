...
<section class="h-100 gradient-form" id="back" style="background-color: #eee;">
  ...
  <?php if (isset($_SESSION['signup_error'] )): ?>
			...
			<?php endif ?>
                 ...
                 <strong> <p>Please Register</p></strong>

                  <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example11">first name</label>
                    <input type="text" id="form2Example11" class="form-control"  name="fname" placeholder="first name" />
                  </div>

                  <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example22">last name</label>
                    <input type="text" id="form2Example22" class="form-control" name="lname"  placeholder="last name" />
                  </div>
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example22">email</label>
                    <input type="email" id="form2Example22" class="form-control" name="email"  placeholder="email" />
                  </div>
                  <div class="form-outline mb-4">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                   ...
                   <a href='view_login.php'> <button type="button" class="btn btn-outline-danger" >login</button></a>
                  </div>
